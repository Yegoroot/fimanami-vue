							...
							<md-tabs md-sync-route class="md-primary" md-alignment="left">
								...
								<md-tab id="tab-pages" md-label="Messages" md-icon="chat">
									<p>
										...
										level that things could be at. I will be the leader of a company that ends up being worth billions
								...
								<md-tab id="tab-posts" md-label="Settings" md-icon="build">
									<p>
										I think that’s a responsibility that I have, to push possibilities, to show people, this is the
										level that things could be at. So when you get something that has the name Kanye West on it, it’s
										supposed to be pushing the furthest possibilities. I will be the leader of a company that ends up
										being worth billions of dollars, because I got the answers. I understand culture. I am the nucleus.
									</p>
								</md-tab>
							</md-tabs>
						</template>
