			...
			<div class="container">
				<div class="md-layout">
					<div class="md-layout-item md-size-50 md-small-size-70 md-xsmall-size-100">
						...
						<br />
						<md-button href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="md-success md-lg" target="_blank"
									...
									<md-card class="md-card-plain">
										...
										<md-card-content>
											<p class="card-description">
												...
												they do. Feel free to add some <a href="#">links</a> for people to be able to follow them
												outside the site.
											</p>
										</md-card-content>
